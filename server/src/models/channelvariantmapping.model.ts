...
export interface IChannelVariantMapping extends Document {
...
const channelVariantMappingSchema = new Schema<IChannelVariantMapping>(
  {
    tenantId: {
...
channelVariantMappingSchema.index(
  { tenantId: 1, outletId: 1, provider: 1, externalVariantId: 1 },
  { unique: true }
);
...
const ChannelVariantMapping: Model<IChannelVariantMapping> =
  mongoose.model<IChannelVariantMapping>(
    "ChannelVariantMapping",
    channelVariantMappingSchema
  );
