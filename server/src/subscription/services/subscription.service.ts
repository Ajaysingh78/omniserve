...
import { ManualGateway } from "../gateways/manual.gateway.js";
import { PaymentGateway } from "../interfaces/payment-gateway.interface.js";
import RestaurantSubscriptionModel, { IRestaurantSubscriptionDocument } from "../models/restaurant-subscription.model.js";
import SubscriptionPlanModel, { ISubscriptionPlanDocument } from "../models/subscription-plan.model.js";
    ...
    const defaultPlans = [
      ...
      },
      {
        ...
        limits: {
          outlets: 2,
          employees: 15,
          monthlyOrders: 1000000, // unlimited approximation
          menuItems: 500,
          storageGB: 5,
        },
        isPopular: true,
      },
      {
        ...
        slug: SubscriptionPlanSlug.PROFESSIONAL,
