...
const IChevDown = () => <svg width={10} height={10} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round"><polyline points="6 9 12 15 18 9"/></svg>;
  ...
  return (
    <header className="topbar">
      ...
      <div className="topbar-actions">
        ...
        <button className="icon-btn"><IRefresh /></button>
        <button className="icon-btn"><IFilter /></button>
        <button className="icon-btn notif-dot"><IBell /></button>
